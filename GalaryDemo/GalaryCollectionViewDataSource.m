...
@interface GalaryCollectionViewDataSource () <UICollectionViewDataSource, UICollectionViewDelegate>
...
@implementation GalaryCollectionViewDataSource
...
- (instancetype)initWithCollectionView:(UICollectionView *)collectionView {
    ...
    if (self = [super init]) {
        ...
        [_collectionView registerClass:[GalaryCollectionViewCell class] forCellWithReuseIdentifier:@"GalaryCollectionViewCell"];
    }
    return self;
}
...
- (void)setupData:(ThreadSafeForMutableArray *)mediaItems {
    ...
    dispatch_async(_loaderItemsQueue, ^{
        ...
        [mediaItems enumerateObjectsUsingBlock:^(id object, NSUInteger idx, BOOL* stop) {
            ...
            GalaryCollectionViewCellObject* cellObject = [[GalaryCollectionViewCellObject alloc] init];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    GalaryCollectionViewCell* cell = (GalaryCollectionViewCell *)[collectionView dequeueReusableCellWithReuseIdentifier:@"GalaryCollectionViewCell" forIndexPath:indexPath];
    GalaryCollectionViewCellObject* model = [_mediaItems objectAtIndex:indexPath.item];
